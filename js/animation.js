...
alert("Happiest B'day Ayu 💕");
alert("Extremely Sorry for late wishes");
alert("Can you please give me 5 minutes from your valuable time on you special day?");
alert("Ayu, Please follow steps and visit till extreme end");

/******************************************************* SETUP ************************************************************/

const config = {
    name: "Ayushi", // actual name of the recipient (Mandatory)

    nickname: "Ayu", // nickname(optional)

    pic: "(../resources/img/bgirl.jpg", //image url of recipients (Mandatory)
...
button.addEventListener("click",function(){
    ...
    if(button.classList.contains("switch")) {
        ...
        */
        ...
        document.querySelector(".HBD").textContent = "Happiest BDay  Ayu";
